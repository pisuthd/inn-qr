...
module weavelink::test_liquidation {
    ...
    fun test_partial_liquidation(deployer: &signer, borrower: &signer, liquidator: &signer) {
        ...
        market_v1::supply(borrower, @0x1111, 1, 500);
        market_v1::supply_collateral(borrower, @0x1111, 1, 200);
        market_v1::borrow(borrower, @0x1111, 1, 80);
        ...
        market_v1::liquidate(liquidator, @0x1111, 1, 40);
        ...
        let (_, _, total_supply, total_borrow, total_collateral, _, _) = market_v1::get_market(1);
    ...
    fun test_full_liquidation(deployer: &signer, borrower: &signer, liquidator: &signer) {
        ...
        market_v1::liquidate(liquidator, @0x1111, 1, 200);
    ...
    fun test_cannot_liquidate_healthy_position(deployer: &signer, borrower: &signer, liquidator: &signer) {
        ...
        market_v1::supply(borrower, @0x1111, 1, 500);
        market_v1::supply_collateral(borrower, @0x1111, 1, 200);
        market_v1::borrow(borrower, @0x1111, 1, 40); // Well within LTV
    ...
    fun test_liquidator_insufficient_balance(deployer: &signer, borrower: &signer, liquidator: &signer) {
        ...
        market_v1::liquidate(liquidator, @0x1111, 1, 80);
    }
    ...
    fun test_sequential_liquidations(deployer: &signer, borrower: &signer, liquidator: &signer) {
        ...
        market_v1::supply(borrower, @0x1111, 1, 500);
        market_v1::supply_collateral(borrower, @0x1111, 1, 100);
        market_v1::borrow(borrower, @0x1111, 1, 80);
        ...
        market_v1::liquidate(liquidator, @0x1111, 1, 30);
        let (_, borrowed1, collateral1) = market_v1::get_position(@0x1111, 1);
        assert!(borrowed1 == 50, 100);   // 80 - 30
        assert!(collateral1 == 70, 101); // 100 - 30

        // Second liquidation: repay remaining 50
        market_v1::liquidate(liquidator, @0x1111, 1, 50);
        let (_, borrowed2, collateral2) = market_v1::get_position(@0x1111, 1);
    ...
    fun test_liquidation_collateral_less_than_debt(deployer: &signer, borrower: &signer, liquidator: &signer) {
        ...
        market_v1::supply(borrower, @0x1111, 1, 500);
        market_v1::supply_collateral(borrower, @0x1111, 1, 50);
        market_v1::borrow(borrower, @0x1111, 1, 40);
    ...
    fun test_health_factor_after_price_crash(deployer: &signer, borrower: &signer) {
        ...
        let hf_before = market_v1::get_health_factor(@0x1111, 1);
        ...
        let hf_after = market_v1::get_health_factor(@0x1111, 1);
